...
byte mls = 140, mrs = 170, mlt = 150, mrt = 150;//mls=140
int reading[7];
byte dread[7];
int err = 0, perr = 0, derr = 0, corr = 0, sen_thr = 500,mlpwm = 0, mrpwm = 0;
const byte  kp = 30, kd = 25, lt_ov = 100, rt_ov = 100, tback_ov=0;
